...
{
  {__LINE__, 17264850929837472839.48234675928374E+271DL, "+1726485092983747283948234675928374e+257", "%s"},
  {__LINE__, 9000000000000000001.83273827374E-212DL, "+0000900000000000000000183273827374e-223", "%s"},
  {__LINE__, 12000000000000000005.00000002000001E-157DL, "+1200000000000000000500000002000001e-171", "%s"},
  {__LINE__, -1000200300040050607008090.01203456E+300DL, "-0100020030004005060700809001203456e+292", "%s"},
  {__LINE__, 2537781477129814100906124727369014E-4DL, "+2537781477129814100906124727369014e-4", "%s"},
  {__LINE__, -2456651838715207419210335722224950E-42DL, "-2456651838715207419210335722224950e-42", "%s"},
  {__LINE__, 31903802797912746463249044.0008815401650E+13DL, "+3190380279791274646324904400088154e+5", "%s"},
  {__LINE__, 0.000000000000000329671851945406791615720896491058158258E-16DL, "+3296718519454067916157208964910582e-65", "%s"},
  
  
  {__LINE__, 1.0E+2DL, "+0000000000000000000000000000000010e+1", "%s"},
  {__LINE__, 123456789.123456E+300DL, "+0000000000000000000123456789123456e+294", "%s"},
  {__LINE__, 2.0E-2DL, "+0000000000000000000000000000000020e-3", "%s"},
  {__LINE__, -2.0E-2DL, "-0000000000000000000000000000000020e-3", "%s"},
  {__LINE__, 0.0000000000000001E-365DL, "+0000000000000000000000000000000001e-381", "%s"},
  {__LINE__, 0.0000000000000001E-366DL, "+0000000000000000000000000000000001e-382", "%s"},
  {__LINE__, 0.0000000000000001E-367DL, "+0000000000000000000000000000000001e-383", "%s"},
  ...
  for (d64ptr = printf_d64s; d64ptr->line; d64ptr++)
    {
      ...
      __get_digits_d64 (d64ptr->d, digits+1, &exp, &is_neg, &is_nan, &is_inf);
      OUT_DIGITS();
  ...
  for (d128ptr = printf_d128s; d128ptr->line; d128ptr++)
    {
      ...
      __get_digits_d128 (d128ptr->d, digits+1, &exp, &is_neg, &is_nan, &is_inf);
      OUT_DIGITS();
